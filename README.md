...
When fraud is detected, **LLaMA 3.3 70B via Groq** automatically generates a human-readable explanation highlighting key risk factors (V14, V10, V12 anomalies).

### AI Chat Interface
Context-aware chat assistant that knows the latest prediction result. Ask questions like:
- *"Why was this transaction flagged?"*
- *"What makes V14 suspicious?"*
- *"What are common fraud patterns?"*

**Stack**: LLaMA 3.3 70B · Groq API · Streamlit Chat UI
